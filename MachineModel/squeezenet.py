...
################ CIFAR 100 ##############
#########################################
class squeezenetCifar100(nn.Module):
    def __init__(self):
        super(squeezenetCifar100,self).__init__()
...
class squeezenetManiCifar100(nn.Module):
    def __init__(self):
        super(squeezenetManiCifar100,self).__init__()
