...
plt.text(manipulate_percentage[-1], darknetMani_delta1[-1], "darknet d[1]", fontsize=14, ha='right', va='bottom') 
plt.text(manipulate_percentage[-1], squeezenetMani_delta1[-1], "squeeze d[1]", fontsize=14, ha='right', va='bottom') 
plt.text(manipulate_percentage[-1], resnet18Mani_delta1[-1], "resnet d[1]", fontsize=14, ha='right', va='bottom') 
plt.text(manipulate_percentage[-1], vgg11Mani_delta1[-1], "vgg11 d[1]", fontsize=14, ha='right', va='bottom') 
plt.text(manipulate_percentage[-1], vgg19Mani_delta1[-1], "vgg19 d[1]", fontsize=14, ha='right', va='bottom') 
...
plt.text(manipulate_percentage[-1], darknetMani_delta2[-1], "darknet d[2]", fontsize=14, ha='right', va='bottom') 
plt.text(manipulate_percentage[-1], squeezenetMani_delta2[-1], "squeeze d[2]", fontsize=14, ha='right', va='bottom') 
plt.text(manipulate_percentage[-1], resnet18Mani_delta2[-1], "resnet d[2]", fontsize=14, ha='right', va='bottom') 
plt.text(manipulate_percentage[-1], vgg11Mani_delta2[-1], "vgg11 d[2]", fontsize=14, ha='right', va='bottom') 
plt.text(manipulate_percentage[-1], vgg19Mani_delta2[-1], "vgg19 d[2]", fontsize=14, ha='right', va='bottom') 
