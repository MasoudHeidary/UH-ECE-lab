...
class SystolicArrayEnv(gym.Env):
    def __init__(self):
        ...
        self.max_inference_delay = self.get_inference_delay(self.max_latency, self.max_backlog_size)
    ...
    def reset(self):
        ...
        self.inference_delay = self.get_inference_delay()

        self.instt = 0
        self.backlog_size = self.instt #random.randrange(0, self.max_backlog_size+1)
        ...
        return np.array([
            ...
            self.inference_delay / self.max_inference_delay,
        ], dtype=np.float32)
    ...
    def update_process(self):
        ...
        self.backlog_size = max(0, self.backlog_size)
        return processed
