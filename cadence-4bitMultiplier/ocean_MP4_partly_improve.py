...
original_normal_alpha =     [192, 192, 192, 192, 160, 160, 204, 236, 144, 172, 194, 228]
original_modified_alpha =   [192, 192, 192, 192, 160, 160, 204, 236, 144, 172, 192, 192]

if False:
    # precentage of change in alpha
    for index_alpha, alpha in enumerate(original_normal_alpha):
        new_alpha = original_modified_alpha[index_alpha]
        print(f"FA-{index_alpha}: [{alpha}]=>[{new_alpha}] ::: [{new_alpha-alpha}] {(new_alpha - alpha)/alpha * 100}%")
...
for t_week in range(1, 100, 1):
    ...
    update_ocean("./tmp_main_MP4.ocn", f"./log/Normal-{t_week}.txt")
    ...
    update_netlist("/home/mheidary/simulation/main_MP4/spectre/schematic/netlist/netlist", pand, pfa)
    update_ocean("./tmp_main_MP4.ocn", f"./log/improved-{t_week}.txt")
    run_ocean_script("./tmp_main_MP4.ocn")
